...
namespace MacroRail
{
    partial class AboutBox1 : Form
    {
        public AboutBox1()
        {
            ...
            try
            {
                using (Stream stream = assembly.GetManifestResourceStream("MacroRail.About.txt"))
        ...
        private void linkLabelGitRepo_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                VisitLink();
        ...
        private void VisitLink()
        {
            ...
            // to true.
            linkLabelGitRepo.LinkVisited = true;
            //Call the Process.Start method to open the default browser
            //with a URL:
            System.Diagnostics.Process.Start("https://github.com/ShaunPrice/MacroRail");
        }
    }
}
