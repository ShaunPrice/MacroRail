...
// This file has been modified to work with the MacroRail application
...
class Tic
{
    ...
    public class Variables
    {
        ...
        public Variables()
        {
            ...
            encoder_position = 0;
            rc_pulse_width = 0;
            analog_readinng_scl = 0;
            analog_readinng_sda = 0;
            analog_readinng_rx = 0;
            analog_readinng_tx = 0;
            digital_readings = 0;
            pin_states = 0;
            step_mode = 0;
            current_limit = 0;
            decay_mode = 0;
            input_state = INPUT_STATE.NOT_READY;
            input_after_averaging = 0;
            input_after_hysteresis = 0;
            input_after_scaling = 0;
        }
    }
    ...
    public class Status_variables
    {
        ...
        public  Status_variables()
        {
            operation_state = new OPERATION_STATE();
            error_status = 0;
            string_error_status = "";
